        ...
        <table>
            ...
            <?php foreach ($songs as $song) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo URL . 'song/deleteSong/' . htmlspecialchars($song->id, ENT_QUOTES, 'UTF-8'); ?>">delete</a></td>
                    <td><a href="<?php echo URL . 'song/editSong/' . htmlspecialchars($song->id, ENT_QUOTES, 'UTF-8'); ?>">edit</a></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
